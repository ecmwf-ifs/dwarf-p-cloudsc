...
- **dwarf-cloudsc-fortran-atlas**: A version of **dwarf-cloudsc-fortran** which uses the [Atlas library](https://github.com/ecmwf/atlas) 
  ...
  CLOUDSC_ATLAS_MULTIFIELD is "0", "OFF", or "FALSE", the variables are managed as atlas::FieldSet,
  which is an array of atlas::Fields. For other values of CLOUDSC_ATLAS_MULTIFIELD, batching of variables is used as (BLK_IDX, LEV, VAR_ID, BLK_ID).
