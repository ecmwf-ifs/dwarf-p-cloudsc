...
1003 format(5x,'NUMPROC=',i0,', NUMOMP=',i0,', NGPTOTG=',i0,', NPROMA=',i0,', NGPBLKS=',i0)
    ...
    ! These calls will allocate data on the device and initiate the data transfers
    ...
    ENDIF
    !  these calls will only set the devtprs, async data movement sare initiated above
    DO QUEUE=1,NQUEUES
