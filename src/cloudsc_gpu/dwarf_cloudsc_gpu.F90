...
#ifdef CLOUDSC_GPU_KERNELS
USE CLOUDSC_DRIVER_GPU_KERNELS_MOD, ONLY: CLOUDSC_DRIVER_GPU_KERNELS
#endif
...
#ifdef CLOUDSC_GPU_KERNELS
print '(1X,A42)', 'Executing CLOUDSC-GPU, "kernels" variant...'

 ! Call the driver to perform the parallel loop over our kernel
CALL CLOUDSC_DRIVER_GPU_KERNELS(NUMOMP, NPROMA, GLOBAL_STATE%KLEV, NGPTOT, NGPTOTG, &
