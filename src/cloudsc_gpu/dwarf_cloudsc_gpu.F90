...
#ifdef CLOUDSC_GPU_OMP_SCC_HOIST_DR_LOOP
USE CLOUDSC_DRIVER_HOIST_DR_LOOP_MOD, ONLY: CLOUDSC_DRIVER_HOIST_DR_LOOP
#endif
...
#if defined(CLOUDSC_GPU_OMP_SCC_HOIST_DR_LOOP)
CALL CLOUDSC_DRIVER_HOIST_DR_LOOP(NUMOMP, NPROMA, GLOBAL_STATE%KLEV, NGPTOT, NGPTOTG, GLOBAL_STATE%NBLOCKS, &
     & GLOBAL_STATE%KFLDX, GLOBAL_STATE%PTSPHY, &
     & GLOBAL_STATE%PT, GLOBAL_STATE%PQ, &
     & GLOBAL_STATE%TENDENCY_CML, GLOBAL_STATE%TENDENCY_TMP, GLOBAL_STATE%TENDENCY_LOC, &
     & GLOBAL_STATE%B_CML,   GLOBAL_STATE%B_TMP, GLOBAL_STATE%B_LOC, &
