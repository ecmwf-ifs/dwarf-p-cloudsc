...
#ifdef CLOUDSC_GPU_SCC_FIELD_ASYNC
print *, 'Executing CLOUDSC-GPU, "SCC-FIELD-ASYNC", NQUEUES', NQUEUES, ", PINNED FIELDS", INIT_PINNED_VALUE
...
CALL CLOUDSC_DRIVER_GPU_SCC_FIELD_ASYNC( &
     ...
     & GLOBAL_STATE%KFLDX, GLOBAL_STATE%PTSPHY, &
     & GLOBAL_STATE%AUX, GLOBAL_STATE%FLUX, &
     & GLOBAL_STATE%TENDENCY_TMP, GLOBAL_STATE%TENDENCY_LOC, NQUEUES)
#endif
