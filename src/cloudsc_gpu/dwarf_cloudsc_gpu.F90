...
USE CLOUDSC_DRIVER_GPU_SCC_K_CACHING_MOD, ONLY: CLOUDSC_DRIVER_GPU_SCC
#endif
...
#ifdef CLOUDSC_GPU_OMP_SCC_DR_LOOP
USE CLOUDSC_DRIVER_GPU_OMP_SCC_DR_LOOP_MOD, ONLY: CLOUDSC_DRIVER_GPU_SCC_CUF
#endif

#ifdef CLOUDSC_GPU_OMP_SCC_K_CACHING_DR_LOOP
USE CLOUDSC_DRIVER_GPU_OMP_SCC_K_CACHING_DR_LOOP_MOD, ONLY: CLOUDSC_DRIVER_GPU_SCC_CUF_K_CACHING
#endif
...
#if defined(CLOUDSC_GPU_SCC_CUF) || defined(CLOUDSC_GPU_OMP_SCC_DR_LOOP)
...
#if defined(CLOUDSC_GPU_SCC_CUF_K_CACHING) || defined(CLOUDSC_GPU_OMP_SCC_K_CACHING_DR_LOOP)
