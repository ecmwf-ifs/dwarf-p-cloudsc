...
#ifdef CLOUDSC_GPU_OMP_SCC_STACKV2
USE CLOUDSC_DRIVER_GPU_OMP_SCC_STACKV2_MOD, ONLY: CLOUDSC_DRIVER_GPU_SCC_STACKV2
#endif

#ifdef CLOUDSC_GPU_OMP_SCC_STACKV3
USE CLOUDSC_DRIVER_GPU_OMP_SCC_STACKV3_MOD, ONLY: CLOUDSC_DRIVER_GPU_SCC_STACKV3
#endif
...
#if defined(CLOUDSC_GPU_SCC_STACK) || defined(CLOUDSC_GPU_OMP_SCC_STACKV2)
print '(1X,A42)', 'Executing CLOUDSC-GPU, "SCC-STACK" variant...'

 ! Call the driver to perform the parallel loop over our kernel
CALL CLOUDSC_DRIVER_GPU_SCC_STACKV2(NUMOMP, NPROMA, GLOBAL_STATE%KLEV, NGPTOT, NGPTOTG, GLOBAL_STATE%NBLOCKS, &
     & GLOBAL_STATE%KFLDX, GLOBAL_STATE%PTSPHY, &
     & GLOBAL_STATE%PT, GLOBAL_STATE%PQ, &
     & GLOBAL_STATE%TENDENCY_CML, GLOBAL_STATE%TENDENCY_TMP, GLOBAL_STATE%TENDENCY_LOC, &
     & GLOBAL_STATE%B_CML,   GLOBAL_STATE%B_TMP, GLOBAL_STATE%B_LOC, &
...
#if defined(CLOUDSC_GPU_SCC_STACK) || defined(CLOUDSC_GPU_OMP_SCC_STACKV3)
print '(1X,A42)', 'Executing CLOUDSC-GPU, "SCC-STACK" variant...'

 ! Call the driver to perform the parallel loop over our kernel
CALL CLOUDSC_DRIVER_GPU_SCC_STACKV3(NUMOMP, NPROMA, GLOBAL_STATE%KLEV, NGPTOT, NGPTOTG, GLOBAL_STATE%NBLOCKS, &
     & GLOBAL_STATE%KFLDX, GLOBAL_STATE%PTSPHY, &
     & GLOBAL_STATE%PT, GLOBAL_STATE%PQ, &
     & GLOBAL_STATE%TENDENCY_CML, GLOBAL_STATE%TENDENCY_TMP, GLOBAL_STATE%TENDENCY_LOC, &
     & GLOBAL_STATE%B_CML,   GLOBAL_STATE%B_TMP, GLOBAL_STATE%B_LOC, &
...
#if defined(CLOUDSC_GPU_SCC_STACK) || defined(CLOUDSC_GPU_OMP_SCC_RAW_STACK)
