...
MODULE CLOUDSC_DRIVER_GPU_OMP_SCC_DR_LOOP_MOD
  ...
  USE CLOUDSC_GPU_OMP_SCC_DR_LOOP_MOD, ONLY: CLOUDSC_SCC_CUF
...
1003 format(5x,'NUMPROC=',i0,', NUMOMP=',i0,', NGPTOTG=',i0,', NPROMA=',i0,', NGPBLKS=',i0)
    ...
    CALL CLOUDSC_SCC_CUF &    
        & (NGPTOT, NPROMA, ICSTART, ICEND, NLEV, NPROMA, NGPBLKS, PTSPHY,&
        & PT,PQ, &
        & BUFFER_TMP, &
        & BUFFER_LOC, &
        & PVFA, PVFL, PVFI, PDYNA, PDYNL, PDYNI, &
...
END MODULE CLOUDSC_DRIVER_GPU_OMP_SCC_DR_LOOP_MOD
