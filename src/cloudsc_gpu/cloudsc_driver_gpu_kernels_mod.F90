MODULE CLOUDSC_DRIVER_GPU_KERNELS_MOD
...
CONTAINS
  ...
  SUBROUTINE CLOUDSC_DRIVER_GPU_KERNELS( &
...
!$acc end data
  ...
  END SUBROUTINE CLOUDSC_DRIVER_GPU_KERNELS

END MODULE CLOUDSC_DRIVER_GPU_KERNELS_MOD
