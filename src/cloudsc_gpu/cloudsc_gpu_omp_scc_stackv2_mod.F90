...
MODULE CLOUDSC_GPU_OMP_SCC_STACKV2_MOD

  CONTAINS
  
  SUBROUTINE CLOUDSC_SCC_STACKV2 (KIDIA, KFDIA, KLON, KLEV, PTSPHY, PT, PQ, TENDENCY_TMP_T, TENDENCY_TMP_Q, TENDENCY_TMP_A,  &
...
!$loki loop seq
  ...
  END SUBROUTINE CLOUDSC_SCC_STACKV2

END MODULE CLOUDSC_GPU_OMP_SCC_STACKV2_MOD
