...
!$acc end data
    ...
    CALL FIELD_STATE%F_PFSQLF%SYNC_HOST_RDWR()
    CALL FIELD_STATE%F_PFSQIF%SYNC_HOST_RDWR()
    CALL FIELD_STATE%F_PFCQLNG%SYNC_HOST_RDWR()
    CALL FIELD_STATE%F_PFCQNNG%SYNC_HOST_RDWR()
    CALL FIELD_STATE%F_PFSQRF%SYNC_HOST_RDWR()
    CALL FIELD_STATE%F_PFSQSF%SYNC_HOST_RDWR()
    CALL FIELD_STATE%F_PFCQRNG%SYNC_HOST_RDWR()
    CALL FIELD_STATE%F_PFCQSNG%SYNC_HOST_RDWR()
    CALL FIELD_STATE%F_PFSQLTUR%SYNC_HOST_RDWR()
    CALL FIELD_STATE%F_PFSQITUR%SYNC_HOST_RDWR()
    CALL FIELD_STATE%F_PFPLSL%SYNC_HOST_RDWR()
    CALL FIELD_STATE%F_PFPLSN%SYNC_HOST_RDWR()
    CALL FIELD_STATE%F_PFHPSL%SYNC_HOST_RDWR()
    CALL FIELD_STATE%F_PFHPSN%SYNC_HOST_RDWR()
