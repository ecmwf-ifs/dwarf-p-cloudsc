...
1003 format(5x,'NUMPROC=',i0,', NUMOMP=',i0,', NGPTOTG=',i0,', NPROMA=',i0,', NGPBLKS=',i0)
    ...
    IF(USE_PACKED)THEN
      CALL FIELD_STATE%AUX%DATA_RDONLY%SYNC_DEVICE_RDONLY()
      CALL FIELD_STATE%FLUX%DATA_WRONLY%SYNC_DEVICE_RDWR()
    ...
    CALL FIELD_STATE%AUX%F_PT%GET_DEVICE_DATA_RDONLY(PT)
    CALL FIELD_STATE%AUX%F_PQ%GET_DEVICE_DATA_RDONLY(PQ)
    CALL FIELD_STATE%AUX%F_PVFA%GET_DEVICE_DATA_RDONLY(PVFA)
    CALL FIELD_STATE%AUX%F_PVFL%GET_DEVICE_DATA_RDONLY(PVFL)
    CALL FIELD_STATE%AUX%F_PVFI%GET_DEVICE_DATA_RDONLY(PVFI)
    CALL FIELD_STATE%AUX%F_PDYNA%GET_DEVICE_DATA_RDONLY(PDYNA)
    CALL FIELD_STATE%AUX%F_PDYNL%GET_DEVICE_DATA_RDONLY(PDYNL)
    CALL FIELD_STATE%AUX%F_PDYNI%GET_DEVICE_DATA_RDONLY(PDYNI)
    CALL FIELD_STATE%AUX%F_PHRSW%GET_DEVICE_DATA_RDONLY(PHRSW)
    CALL FIELD_STATE%AUX%F_PHRLW%GET_DEVICE_DATA_RDONLY(PHRLW)
    CALL FIELD_STATE%AUX%F_PVERVEL%GET_DEVICE_DATA_RDONLY(PVERVEL)
    CALL FIELD_STATE%AUX%F_PAP%GET_DEVICE_DATA_RDONLY(PAP)
    CALL FIELD_STATE%AUX%F_PLU%GET_DEVICE_DATA_RDONLY(PLU)
    CALL FIELD_STATE%AUX%F_PSNDE%GET_DEVICE_DATA_RDONLY(PSNDE)
    CALL FIELD_STATE%AUX%F_PMFU%GET_DEVICE_DATA_RDONLY(PMFU)
    CALL FIELD_STATE%AUX%F_PMFD%GET_DEVICE_DATA_RDONLY(PMFD)
    CALL FIELD_STATE%AUX%F_PA%GET_DEVICE_DATA_RDONLY(PA)
    CALL FIELD_STATE%AUX%F_PSUPSAT%GET_DEVICE_DATA_RDONLY(PSUPSAT)
    CALL FIELD_STATE%AUX%F_PLCRIT_AER%GET_DEVICE_DATA_RDONLY(PLCRIT_AER)
    CALL FIELD_STATE%AUX%F_PICRIT_AER%GET_DEVICE_DATA_RDONLY(PICRIT_AER)
    CALL FIELD_STATE%AUX%F_PRE_ICE%GET_DEVICE_DATA_RDONLY(PRE_ICE)
    CALL FIELD_STATE%AUX%F_PCCN%GET_DEVICE_DATA_RDONLY(PCCN)
    CALL FIELD_STATE%AUX%F_PNICE%GET_DEVICE_DATA_RDONLY(PNICE)
    
    CALL FIELD_STATE%AUX%F_PAPH%GET_DEVICE_DATA_RDONLY(PAPH)
    CALL FIELD_STATE%AUX%F_PLSM%GET_DEVICE_DATA_RDONLY(PLSM)
    CALL FIELD_STATE%AUX%F_LDCUM%GET_DEVICE_DATA_RDONLY(LDCUM)
    CALL FIELD_STATE%AUX%F_KTYPE%GET_DEVICE_DATA_RDONLY(KTYPE)
    CALL FIELD_STATE%AUX%F_PCLV%GET_DEVICE_DATA_RDONLY(PCLV)
    ...
    CALL FIELD_STATE%AUX%F_PLUDE%GET_DEVICE_DATA_RDWR(PLUDE)
    CALL FIELD_STATE%AUX%F_PCOVPTOT%GET_DEVICE_DATA_RDWR(PCOVPTOT)
    CALL FIELD_STATE%AUX%F_PRAINFRAC_TOPRFZ%GET_DEVICE_DATA_RDWR(PRAINFRAC_TOPRFZ)
    
    CALL FIELD_STATE%FLUX%F_PFSQLF%GET_DEVICE_DATA_RDWR(PFSQLF)
    CALL FIELD_STATE%FLUX%F_PFSQIF%GET_DEVICE_DATA_RDWR(PFSQIF)
    CALL FIELD_STATE%FLUX%F_PFCQLNG%GET_DEVICE_DATA_RDWR(PFCQLNG)
    CALL FIELD_STATE%FLUX%F_PFCQNNG%GET_DEVICE_DATA_RDWR(PFCQNNG)
    CALL FIELD_STATE%FLUX%F_PFSQRF%GET_DEVICE_DATA_RDWR(PFSQRF)
    CALL FIELD_STATE%FLUX%F_PFSQSF%GET_DEVICE_DATA_RDWR(PFSQSF)
    CALL FIELD_STATE%FLUX%F_PFCQRNG%GET_DEVICE_DATA_RDWR(PFCQRNG)
    CALL FIELD_STATE%FLUX%F_PFCQSNG%GET_DEVICE_DATA_RDWR(PFCQSNG)
    CALL FIELD_STATE%FLUX%F_PFSQLTUR%GET_DEVICE_DATA_RDWR(PFSQLTUR)
    CALL FIELD_STATE%FLUX%F_PFSQITUR%GET_DEVICE_DATA_RDWR(PFSQITUR)
    CALL FIELD_STATE%FLUX%F_PFPLSL%GET_DEVICE_DATA_RDWR(PFPLSL)
    CALL FIELD_STATE%FLUX%F_PFPLSN%GET_DEVICE_DATA_RDWR(PFPLSN)
    CALL FIELD_STATE%FLUX%F_PFHPSL%GET_DEVICE_DATA_RDWR(PFHPSL)
    CALL FIELD_STATE%FLUX%F_PFHPSN%GET_DEVICE_DATA_RDWR(PFHPSN)
...
!$acc end data
    ...
    IF(USE_PACKED)THEN
       CALL FIELD_STATE%AUX%SYNC_HOST()
       CALL FIELD_STATE%FLUX%SYNC_HOST()
       ! If this is called then the subsequent FIELD_STATE%FIELDS_RWONLY%PTR%SYNC_HOST_RDWR() calls
       ! don't trigger any data movement
    ENDIF

    CALL FIELD_STATE%AUX%F_PLUDE%SYNC_HOST_RDWR()
    CALL FIELD_STATE%AUX%F_PCOVPTOT%SYNC_HOST_RDWR()
    CALL FIELD_STATE%AUX%F_PRAINFRAC_TOPRFZ%SYNC_HOST_RDWR()
    CALL FIELD_STATE%FLUX%F_PFSQLF%SYNC_HOST_RDWR()
    CALL FIELD_STATE%FLUX%F_PFSQIF%SYNC_HOST_RDWR()
    CALL FIELD_STATE%FLUX%F_PFCQLNG%SYNC_HOST_RDWR()
    CALL FIELD_STATE%FLUX%F_PFCQNNG%SYNC_HOST_RDWR()
    CALL FIELD_STATE%FLUX%F_PFSQRF%SYNC_HOST_RDWR()
    CALL FIELD_STATE%FLUX%F_PFSQSF%SYNC_HOST_RDWR()
    CALL FIELD_STATE%FLUX%F_PFCQRNG%SYNC_HOST_RDWR()
    CALL FIELD_STATE%FLUX%F_PFCQSNG%SYNC_HOST_RDWR()
    CALL FIELD_STATE%FLUX%F_PFSQLTUR%SYNC_HOST_RDWR()
    CALL FIELD_STATE%FLUX%F_PFSQITUR%SYNC_HOST_RDWR()
    CALL FIELD_STATE%FLUX%F_PFPLSL%SYNC_HOST_RDWR()
    CALL FIELD_STATE%FLUX%F_PFPLSN%SYNC_HOST_RDWR()
    CALL FIELD_STATE%FLUX%F_PFHPSL%SYNC_HOST_RDWR()
    CALL FIELD_STATE%FLUX%F_PFHPSN%SYNC_HOST_RDWR()
