...
MODULE CLOUDSC_DRIVER_STD_PAR_SCC_K_CACHING_MOD
  ...
  USE CLOUDSC_STD_PAR_SCC_K_CACHING_MOD, ONLY: CLOUDSC_SCC_K_CACHING

  IMPLICIT NONE
  
  CONTAINS
  
  SUBROUTINE CLOUDSC_DRIVER_STD_PAR_SCC_K_CACHING (NUMOMP, NPROMA, NLEV, NGPTOT, NGPTOTG, NGPBLKS, KFLDX, PTSPHY, PT, PQ, TENDENCY_CML, TENDENCY_TMP,  &
 ...
 1003 FORMAT(5X, 'NUMPROC=', I0, ', NUMOMP=', I0, ', NGPTOTG=', I0, ', NPROMA=', I0, ', NGPBLKS=', I0)
    ...
    CALL CLOUDSC_SCC_K_CACHING(1, NGPTOT, NPROMA, ICEND, NPROMA, NLEV, PTSPHY, PT, PQ, BUFFER_TMP, BUFFER_LOC, PVFA,  &
    ...
    & PFSQLTUR, PFSQITUR, PFPLSL, PFPLSN, PFHPSL, PFHPSN, YRECLDP, NGPBLKS)
  ...
  END SUBROUTINE CLOUDSC_DRIVER_STD_PAR_SCC_K_CACHING
  
END MODULE CLOUDSC_DRIVER_STD_PAR_SCC_K_CACHING_MOD
