...
void cloudsc_driver(int numthreads, int numcols, int nproma) {
  ...
  d_yrecldp = (TECLDP*) cl::sycl::malloc_device( sizeof(TECLDP), q); //cl::sycl::malloc_device(sizeof(struct TECLDP), q); //cl::sycl::malloc_device<struct TECLDP>(1, q);
