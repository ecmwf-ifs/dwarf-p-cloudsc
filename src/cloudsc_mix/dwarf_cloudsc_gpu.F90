...
#if GPU_OFFLOAD == ACC_OFFLOAD &&  GPU_LANG == CUDA_LANG
  print '(1X,A60)', 'Executing CLOUDSC, OFFLOAD: ACC, LANG: CUDA  ...'
#elif GPU_OFFLOAD == ACC_OFFLOAD && GPU_LANG == HIP_LANG
  print '(1X,A60)', 'Executing CLOUDSC, OFFLOAD: ACC, LANG: HIP  ...'
#elif GPU_OFFLOAD == ACC_OFFLOAD && GPU_LANG == SYCL_LANG
  print '(1X,A60)', 'Executing CLOUDSC, OFFLOAD: ACC, LANG: SYCL  ...'
#elif GPU_OFFLOAD == OMP_OFFLOAD &&  GPU_LANG == CUDA_LANG
  print '(1X,A60)', 'Executing CLOUDSC, OFFLOAD: OMP, LANG: CUDA  ...'
#elif GPU_OFFLOAD == OMP_OFFLOAD && GPU_LANG == HIP_LANG
  print '(1X,A60)', 'Executing CLOUDSC, OFFLOAD: OMP, LANG: HIP  ...'
#elif GPU_OFFLOAD == OMP_OFFLOAD && GPU_LANG == SYCL_LANG
  print '(1X,A60)', 'Executing CLOUDSC, OFFLOAD: OMP, LANG: SYCL  ...'
#else
  CALL ABOR1('ERROR: Unsupported OFFLOAD and/or GPU LANG!')
#endif
