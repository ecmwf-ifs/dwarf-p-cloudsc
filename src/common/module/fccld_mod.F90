...
MODULE FCCLD_MOD
  ...
  REAL(KIND=JPRB),PUBLIC, PROTECTED :: &
       RKOOP1,RKOOP2 
!$acc declare copyin (RKOOP1, RKOOP2)
  CONTAINS

  SUBROUTINE FCCLD_CONSTANTS_SET(RKOOP1_IN, RKOOP2_IN)
  REAL(KIND=JPRB), INTENT(IN) :: RKOOP1_IN, RKOOP2_IN 
  RKOOP1 = RKOOP1_IN
  RKOOP2 = RKOOP2_IN
  END SUBROUTINE FCCLD_CONSTANTS_SET
