...
#ifdef HAVE_CUDA
ATTRIBUTES(CONSTANT) :: YRECLDP_RAMID, YRECLDP_RCLDIFF, YRECLDP_RCLDIFF_CONVI, &
 & YRECLDP_RCLCRIT, YRECLDP_RCLCRIT_SEA, YRECLDP_RCLCRIT_LAND, &
 & YRECLDP_RKCONV, YRECLDP_RPRC1, YRECLDP_RPRC2, YRECLDP_RCLDMAX, &
 & YRECLDP_RPECONS, YRECLDP_RVRFACTOR, YRECLDP_RPRECRHMAX, &
 & YRECLDP_RTAUMEL, YRECLDP_RAMIN, YRECLDP_RLMIN, YRECLDP_RKOOPTAU, &
 & YRECLDP_RCLDTOPP, YRECLDP_RLCRITSNOW, YRECLDP_RSNOWLIN1, &
 & YRECLDP_RSNOWLIN2, YRECLDP_RICEHI1, YRECLDP_RICEHI2, YRECLDP_RICEINIT, &
 & YRECLDP_RVICE, YRECLDP_RVRAIN, YRECLDP_RVSNOW, YRECLDP_RTHOMO, &
 & YRECLDP_RCOVPMIN, YRECLDP_RCCN, YRECLDP_RNICE, YRECLDP_RCCNOM, &
 & YRECLDP_RCCNSS, YRECLDP_RCCNSU, YRECLDP_RCLDTOPCF, &
 & YRECLDP_RDEPLIQREFRATE, YRECLDP_RDEPLIQREFDEPTH 

ATTRIBUTES(CONSTANT) :: YRECLDP_RCL_KKAac, YRECLDP_RCL_KKBac, YRECLDP_RCL_KKAau, &
 & YRECLDP_RCL_KKBauq, YRECLDP_RCL_KKBaun, YRECLDP_RCL_KK_cloud_num_sea, &
 & YRECLDP_RCL_KK_cloud_num_land

ATTRIBUTES(CONSTANT) :: YRECLDP_RCL_AI, YRECLDP_RCL_BI, YRECLDP_RCL_CI, &
  & YRECLDP_RCL_DI, YRECLDP_RCL_X1I, YRECLDP_RCL_X2I, YRECLDP_RCL_X3I, &
  & YRECLDP_RCL_X4I, YRECLDP_RCL_CONST1I, YRECLDP_RCL_CONST2I, YRECLDP_RCL_CONST3I, &
  & YRECLDP_RCL_CONST4I, YRECLDP_RCL_CONST5I, YRECLDP_RCL_CONST6I, YRECLDP_RCL_APB1, &
  & YRECLDP_RCL_APB2, YRECLDP_RCL_APB3

ATTRIBUTES(CONSTANT) :: YRECLDP_RCL_AS, YRECLDP_RCL_BS, YRECLDP_RCL_CS, YRECLDP_RCL_DS, &
  & YRECLDP_RCL_X1S, YRECLDP_RCL_X2S, YRECLDP_RCL_X3S, YRECLDP_RCL_X4S, YRECLDP_RCL_CONST1S, &
  & YRECLDP_RCL_CONST2S, YRECLDP_RCL_CONST3S, YRECLDP_RCL_CONST4S, YRECLDP_RCL_CONST5S, &
  & YRECLDP_RCL_CONST6S, YRECLDP_RCL_CONST7S, YRECLDP_RCL_CONST8S

ATTRIBUTES(CONSTANT) :: YRECLDP_RDENSWAT, YRECLDP_RDENSREF, YRECLDP_RCL_AR, YRECLDP_RCL_BR, &
  & YRECLDP_RCL_CR, YRECLDP_RCL_DR, YRECLDP_RCL_X1R, YRECLDP_RCL_X2R, YRECLDP_RCL_X4R, &
  & YRECLDP_RCL_KA273, YRECLDP_RCL_CDENOM1, YRECLDP_RCL_CDENOM2, YRECLDP_RCL_CDENOM3, &
  & YRECLDP_RCL_SCHMIDT, YRECLDP_RCL_DYNVISC, YRECLDP_RCL_CONST1R, YRECLDP_RCL_CONST2R, &
  & YRECLDP_RCL_CONST3R, YRECLDP_RCL_CONST4R, YRECLDP_RCL_FAC1, YRECLDP_RCL_FAC2, &
  & YRECLDP_RCL_CONST5R, YRECLDP_RCL_CONST6R, YRECLDP_RCL_FZRAB, YRECLDP_RCL_FZRBB

ATTRIBUTES(CONSTANT) :: YRECLDP_LCLDEXTRA, YRECLDP_LCLDBUDGET, YRECLDP_NSSOPT, &
  & YRECLDP_NCLDTOP, YRECLDP_NAECLBC, YRECLDP_NAECLDU, YRECLDP_NAECLOM, YRECLDP_NAECLSS, &
  & YRECLDP_NAECLSU, YRECLDP_NCLDDIAG

ATTRIBUTES(CONSTANT) :: YRECLDP_NAERCLD, YRECLDP_LAERLIQAUTOLSP, YRECLDP_LAERLIQAUTOCP, &
  & YRECLDP_LAERLIQAUTOCPB, YRECLDP_LAERLIQCOLL, YRECLDP_LAERICESED, YRECLDP_LAERICEAUTO


ATTRIBUTES(CONSTANT) :: YRECLDP_NSHAPEP, YRECLDP_NSHAPEQ, YRECLDP_NBETA, YRECLDP_RBETA, YRECLDP_RBETAP1
#endif
