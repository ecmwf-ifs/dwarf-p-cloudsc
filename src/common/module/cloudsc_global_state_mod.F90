...
MODULE CLOUDSC_GLOBAL_STATE_MOD
  ...
  USE VALIDATE_MOD, ONLY: VALIDATE, VALIDATE_R2_K, VALIDATE_R3_K
...
!$omp end parallel do 
  ...
  SUBROUTINE CLOUDSC_GLOBAL_STATE_VALIDATE(SELF, NPROMA, NGPTOT, NGPTOTG)
    ...
    CALL VALIDATE_R2_K('TENDENCY_LOC%A', B_LOC(:,:,:,:), SELF%B_LOC(:,:,:,:), NPROMA, SELF%KLEV, NGPTOT, NBLOCKS, NGPTOTG, 2)
    CALL VALIDATE_R2_K('TENDENCY_LOC%Q', B_LOC(:,:,:,:), SELF%B_LOC(:,:,:,:), NPROMA, SELF%KLEV, NGPTOT, NBLOCKS, NGPTOTG, 3)
    CALL VALIDATE_R2_K('TENDENCY_LOC%T', B_LOC(:,:,:,:), SELF%B_LOC(:,:,:,:), NPROMA, SELF%KLEV, NGPTOT, NBLOCKS, NGPTOTG, 1)
    CALL VALIDATE_R3_K('TENDENCY_LOC%CLD', B_LOC(:,:,:,:), SELF%B_LOC(:,:,:,:), NPROMA, SELF%KLEV, NCLV, NGPTOT, NBLOCKS, NGPTOTG, 3)
