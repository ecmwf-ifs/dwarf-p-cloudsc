...
MODULE CLOUDSC_GLOBAL_STATE_MOD
  ...
  CONTAINS
    ...
    PROCEDURE :: FINALIZE => CLOUDSC_GLOBAL_STATE_FINALIZE
...
!$omp end parallel do 
  ...
  SUBROUTINE CLOUDSC_GLOBAL_STATE_FINALIZE(SELF)
    ! Deallocate data
    CLASS(CLOUDSC_GLOBAL_STATE) :: SELF
    ...
    DEALLOCATE(SELF%PLSM)
    DEALLOCATE(SELF%LDCUM)
    DEALLOCATE(SELF%KTYPE)
    DEALLOCATE(SELF%PLU)
    DEALLOCATE(SELF%PLUDE)
    DEALLOCATE(SELF%PSNDE)
    DEALLOCATE(SELF%PMFU)
    DEALLOCATE(SELF%PMFD)
    DEALLOCATE(SELF%PA)
    DEALLOCATE(SELF%PCLV)
    DEALLOCATE(SELF%PSUPSAT)
    DEALLOCATE(SELF%TENDENCY_LOC)
    DEALLOCATE(SELF%B_LOC)
    DEALLOCATE(SELF%TENDENCY_CML)
    DEALLOCATE(SELF%B_CML)
    DEALLOCATE(SELF%TENDENCY_TMP)
    DEALLOCATE(SELF%B_TMP)
    DEALLOCATE(SELF%PRAINFRAC_TOPRFZ)
    DEALLOCATE(SELF%PCOVPTOT)
    DEALLOCATE(SELF%PFSQLF)
    DEALLOCATE(SELF%PFSQIF)
    DEALLOCATE(SELF%PFCQLNG)
    DEALLOCATE(SELF%PFCQNNG)
    DEALLOCATE(SELF%PFSQRF)
    DEALLOCATE(SELF%PFSQSF)
    DEALLOCATE(SELF%PFCQRNG)
    DEALLOCATE(SELF%PFCQSNG)
    DEALLOCATE(SELF%PFSQLTUR)
    DEALLOCATE(SELF%PFSQITUR)
    DEALLOCATE(SELF%PFPLSL)
    DEALLOCATE(SELF%PFPLSN)
    DEALLOCATE(SELF%PFHPSL)
    DEALLOCATE(SELF%PFHPSN)

  END SUBROUTINE CLOUDSC_GLOBAL_STATE_FINALIZE
