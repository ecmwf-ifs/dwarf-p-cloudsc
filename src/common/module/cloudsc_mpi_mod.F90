module cloudsc_mpi_mod
  ...
  interface cloudsc_mpi_reduce
    procedure cloudsc_mpi_reduce_jprd, cloudsc_mpi_reduce_int
  end interface cloudsc_mpi_reduce

  interface cloudsc_mpi_reduce_sum
#ifdef HAVE_MPI
    procedure cloudsc_mpi_reduce_sum_jprd, cloudsc_mpi_reduce_sum_int
#else
    procedure cloudsc_mpi_reduce_dummy_jprd, cloudsc_mpi_reduce_dummy_int
#endif
  end interface cloudsc_mpi_reduce_sum

  interface cloudsc_mpi_reduce_min
#ifdef HAVE_MPI
    procedure cloudsc_mpi_reduce_min_jprd, cloudsc_mpi_reduce_min_int
#else
    procedure cloudsc_mpi_reduce_dummy_jprd, cloudsc_mpi_reduce_dummy_int
#endif
...
#ifdef HAVE_MPI
    procedure cloudsc_mpi_reduce_max_jprd, cloudsc_mpi_reduce_max_int
#else
    procedure cloudsc_mpi_reduce_dummy_jprd, cloudsc_mpi_reduce_dummy_int
#endif
  ...
  interface cloudsc_mpi_gather
    procedure cloudsc_mpi_gather_jprd, cloudsc_mpi_gather_int
