...
!     ------------------------------------------------------------------
 ...
 &                   RTWAT_RTICE_R, RTWAT_RTICECU_R, RKOOP1, RKOOP2
  ...
  !     *****************************************************************
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOEDELTA(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOEEW(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOEDE(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOEDESU(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOELH(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOELDCP(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOEALFA(PTARE)
  ...
  !        INPUT : PTARE = TEMPERATURE
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOEEWM(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOE_DEWM_DT(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOEDEM(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOELDCPM(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOELHM(PTARE)
  ...
  !        INPUT : PTARE = TEMPERATURE
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOETB(PTARE)
  ...
  !               INPUT : PTARE = TEMPERATURE
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOEALFCU(PTARE)
  ...
  !     Pressure of water vapour at saturation
  !        INPUT : PTARE = TEMPERATURE
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOEEWMCU(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOEDEMCU(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOELDCPMCU(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOELHMCU(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOEEWMO(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOEELIQ(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOEEICE(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOELSON(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOELES_V(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOEIES_V(PTARE)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOEEWM_V(PTARE,EXP1,EXP2)
...
CUDA_DEVICE  PURE ELEMENTAL FUNCTION FOEEWMCU_V(PTARE,EXP1,EXP2)
