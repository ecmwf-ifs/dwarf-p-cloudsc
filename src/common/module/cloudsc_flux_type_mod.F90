...
CONTAINS
  ...
  SUBROUTINE FLUX_TYPE_INIT(SELF,NPROMA, NGPTOT, KLON, KLEV, KFLDX, NBLOCKS, NGPTOTG, USE_PACKED)
    ...
    IF (SELF%PACKED) THEN
      CALL FIELD_NEW(SELF%DATA_WRONLY, LSTACK=.TRUE., UBOUNDS=[NPROMA, KLEV+1, NFIELDS, NBLOCKS], &
      &                          PERSISTENT=.TRUE., INIT_VALUE=0._JPRB)
      CALL GET_STACK_MEMBER(SELF%DATA_WRONLY, 1, SELF%F_PFSQLF)
      CALL GET_STACK_MEMBER(SELF%DATA_WRONLY, 2, SELF%F_PFSQIF)
      CALL GET_STACK_MEMBER(SELF%DATA_WRONLY, 3, SELF%F_PFCQLNG)
      CALL GET_STACK_MEMBER(SELF%DATA_WRONLY, 4, SELF%F_PFCQNNG)
      CALL GET_STACK_MEMBER(SELF%DATA_WRONLY, 5, SELF%F_PFSQRF)
      CALL GET_STACK_MEMBER(SELF%DATA_WRONLY, 6, SELF%F_PFSQSF)
      CALL GET_STACK_MEMBER(SELF%DATA_WRONLY, 7, SELF%F_PFCQRNG)
      CALL GET_STACK_MEMBER(SELF%DATA_WRONLY, 8, SELF%F_PFCQSNG)
      CALL GET_STACK_MEMBER(SELF%DATA_WRONLY, 9, SELF%F_PFSQLTUR)
      CALL GET_STACK_MEMBER(SELF%DATA_WRONLY, 10, SELF%F_PFSQITUR)
      CALL GET_STACK_MEMBER(SELF%DATA_WRONLY, 11, SELF%F_PFPLSL)
      CALL GET_STACK_MEMBER(SELF%DATA_WRONLY, 12, SELF%F_PFPLSN)
      CALL GET_STACK_MEMBER(SELF%DATA_WRONLY, 13, SELF%F_PFHPSL)
      CALL GET_STACK_MEMBER(SELF%DATA_WRONLY, 14, SELF%F_PFHPSN)
    ELSE
