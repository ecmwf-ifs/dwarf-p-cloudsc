...
CONTAINS
  ...
  SUBROUTINE AUX_TYPE_INIT(SELF,NPROMA, NGPTOT, KLON, KLEV, KFLDX, NBLOCKS, NGPTOTG, USE_PACKED)
    ...
    ! 3D rdonly fields
    IF (SELF%PACKED) THEN
      CALL FIELD_NEW(SELF%DATA_RDONLY, LSTACK=.TRUE., UBOUNDS=[NPROMA, KLEV, NFIELDS, NBLOCKS], &
      &                          PERSISTENT=.TRUE.)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 1, SELF%F_PLCRIT_AER)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 2, SELF%F_PICRIT_AER)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 3, SELF%F_PRE_ICE)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 4, SELF%F_PCCN)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 5, SELF%F_PNICE)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 6, SELF%F_PT)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 7, SELF%F_PQ)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 8, SELF%F_PVFA)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 9, SELF%F_PVFL)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 10, SELF%F_PVFI)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 11, SELF%F_PDYNA)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 12, SELF%F_PDYNL)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 13, SELF%F_PDYNI)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 14, SELF%F_PHRSW)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 15, SELF%F_PHRLW)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 16, SELF%F_PVERVEL)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 17, SELF%F_PAP)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 18, SELF%F_PLU)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 19, SELF%F_PSNDE)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 20, SELF%F_PMFU)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 21, SELF%F_PMFD)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 22, SELF%F_PA)
      CALL GET_STACK_MEMBER(SELF%DATA_RDONLY, 23, SELF%F_PSUPSAT)
    ELSE
