...
#ifdef HAVE_CUDA
REAL(KIND=JPRB) :: R2ES_H, R3LES_H, R3IES_H, R4LES_H, R4IES_H, R5LES_H, R5IES_H, RVTMP2_H, &
 & RHOH2O_H, R5ALVCP_H, R5ALSCP_H, RALVDCP_H, RALSDCP_H, RALFDCP_H, RTWAT_H, RTBER_H, &
 & RTBERCU_H, RTICE_H, RTICECU_H, RTWAT_RTICE_R_H, RTWAT_RTICECU_R_H, RKOOP1_H, RKOOP2_H
...
#ifdef HAVE_CUDA
attributes(host)  SUBROUTINE YOETHF_LOAD_PARAMETERS()
