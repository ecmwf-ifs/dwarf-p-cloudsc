...
from loki.jit_build import Builder, jit_compile_lib, Obj, Lib
...
def main(ngptot, nproma):
    ...
    include_dirs = [
        tmp_path,
        build_dir/'cloudsc-dwarf/src/common.dp/module-lib',
    ...
    CDLL(build_dir/'lib64/libcloudsc_common.dp.lib.so')

    cloudsc_fc = lib.wrap(
        modname='cloudsc_fc', sources=sources, builder=builder,
        libs=['cloudsc_common.dp.lib'], lib_dirs=[build_dir/'lib64'],
