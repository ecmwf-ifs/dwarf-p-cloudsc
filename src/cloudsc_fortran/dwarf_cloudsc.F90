...
CHARACTER(LEN=20) :: PACKED_STORAGE, WRITE_OUTPUT
LOGICAL :: USE_PACKED, DO_WRITE_OUTPUT
...
#ifdef CLOUDSC_FIELD
! Write computed output if requested
CALL GET_ENVIRONMENT_VARIABLE('CLOUDSC_WRITE_OUTPUT', WRITE_OUTPUT)
DO_WRITE_OUTPUT = TRIM(WRITE_OUTPUT) == 'ON' .OR. TRIM(WRITE_OUTPUT) == '1'
IF(DO_WRITE_OUTPUT)  CALL GLOBAL_STATE%WRITE_OUTPUT()
#endif
