...
CONTAINS
  ...
  SUBROUTINE VALIDATEVAR_ATLAS(FSET, FSPACE, NAME, NLON, NGPTOTG)
    ...
    ELSE IF (FRANK == 3) THEN
        CALL LOAD_AND_EXPAND(NAME, REF_R3, NLON, NLEV, NPROMA, NGPTOT, NBLOCKS, NGPTOTG)
    ...
    ELSE IF (FRANK == 4) THEN
        NDIM = FIELD%SHAPE(3)
        CALL LOAD_AND_EXPAND(NAME, REF_R4, NLON, NLEV, NDIM, NPROMA, NGPTOT, NBLOCKS, NGPTOTG)
