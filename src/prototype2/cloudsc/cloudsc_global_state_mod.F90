MODULE CLOUDSC_GLOBAL_STATE_MOD
  ...
  USE LOAD_STATE_MOD, ONLY: QUERY_DIMENSIONS, LOAD_AND_EXPAND, LOAD_AND_EXPAND_STATE, INITIALISE_PARAMETERS, FINALIZE
...
CONTAINS
  ...
  SUBROUTINE CLOUDSC_GLOBAL_STATE_VALIDATE(THIS, NPROMA, NGPTOT)
    ...
    CALL VALIDATE('PLUDE', PLUDE, THIS%PLUDE, KLON, THIS%KLEV, NGPTOT, NBLOCKS)
    CALL VALIDATE('PCOVPTOT', PCOVPTOT, THIS%PCOVPTOT, KLON, THIS%KLEV, NGPTOT, NBLOCKS)
    CALL VALIDATE('PRAINFRAC_TOPRFZ', PRAINFRAC_TOPRFZ, THIS%PRAINFRAC_TOPRFZ, KLON, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFSQLF', PFSQLF, THIS%PFSQLF, KLON, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFSQIF', PFSQIF, THIS%PFSQIF, KLON, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFCQLNG', PFCQLNG, THIS%PFCQLNG, KLON, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFCQNNG', PFCQNNG, THIS%PFCQNNG, KLON, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFSQRF', PFSQRF, THIS%PFSQRF, KLON, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFSQSF', PFSQSF, THIS%PFSQSF, KLON, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFCQRNG', PFCQRNG, THIS%PFCQRNG, KLON, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFCQSNG', PFCQSNG, THIS%PFCQSNG, KLON, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFSQLTUR', PFSQLTUR, THIS%PFSQLTUR, KLON, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFSQITUR', PFSQITUR, THIS%PFSQITUR, KLON, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFPLSL', PFPLSL, THIS%PFPLSL, KLON, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFPLSN', PFPLSN, THIS%PFPLSN, KLON, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFHPSL', PFHPSL, THIS%PFHPSL, KLON, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFHPSN', PFHPSN, THIS%PFHPSN, KLON, THIS%KLEV+1, NGPTOT, NBLOCKS)
    ! This is extremly hacky, but the array-of-struct-of-array layout demands it.
    CALL VALIDATE('TENDENCY_LOC%A', B_LOC(:,:,5,:), THIS%B_LOC(:,:,5,:), KLON, THIS%KLEV, NGPTOT, NBLOCKS)
    CALL VALIDATE('TENDENCY_LOC%Q', B_LOC(:,:,6,:), THIS%B_LOC(:,:,6,:), KLON, THIS%KLEV, NGPTOT, NBLOCKS)
    CALL VALIDATE('TENDENCY_LOC%T', B_LOC(:,:,3,:), THIS%B_LOC(:,:,3,:), KLON, THIS%KLEV, NGPTOT, NBLOCKS)
    CALL VALIDATE('TENDENCY_LOC%CLD', B_LOC(:,:,7:,:), THIS%B_LOC(:,:,7:,:), KLON, THIS%KLEV, NCLV, NGPTOT, NBLOCKS)
