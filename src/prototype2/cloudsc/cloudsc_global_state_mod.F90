MODULE CLOUDSC_GLOBAL_STATE_MOD
  ...
  USE LOAD_STATE_MOD, ONLY: QUERY_DIMENSIONS, LOAD_AND_EXPAND, LOAD_AND_EXPAND_STATE
...
CONTAINS
  ...
  SUBROUTINE CLOUDSC_GLOBAL_STATE_LOAD(THIS, NPROMA, NGPTOT)
    ...
    CALL FIELD_INIT(THIS%TENDENCY_CML, THIS%B_CML, NPROMA, THIS%KLEV, NCLV, NBLOCKS)
    CALL FIELD_INIT(THIS%TENDENCY_TMP, THIS%B_TMP, NPROMA, THIS%KLEV, NCLV, NBLOCKS)
    CALL LOAD_AND_EXPAND_STATE('TENDENCY_CML', THIS%B_CML, KLON, THIS%KLEV, NCLV, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND_STATE('TENDENCY_TMP', THIS%B_TMP, KLON, THIS%KLEV, NCLV, NPROMA, NGPTOT, NBLOCKS)
