...
!!! & PQAER,    KAER, &
 ...
 & YRECLDP) ! , RG, RD, RCPD, RETV, RLVTT, RLSTT, RLMLT, RTT, RV, & 
...
!!
!===============================================================================
USE CLOUDSC_INIT_SEQ_MOD, ONLY : CLOUDSC_INIT_SEQ
USE CLOUDSC_INIT_VEC_MOD, ONLY : CLOUDSC_INIT_VEC
...
USE YOETHF   , ONLY : R2ES, R3LES, R3IES, R4LES, R4IES, R5LES, R5IES, & 
        & R5ALVCP, R5ALSCP, RALVDCP, RALSDCP, RALFDCP, RTWAT, RTICE, & 
...
! REAL(KIND=JPRB), INTENT(IN) :: RCPD
! REAL(KIND=JPRB), INTENT(IN) :: RETV
! REAL(KIND=JPRB), INTENT(IN) :: RLVTT
! REAL(KIND=JPRB), INTENT(IN) :: RLSTT
! REAL(KIND=JPRB), INTENT(IN) :: RLMLT
! REAL(KIND=JPRB), INTENT(IN) :: RTT
! REAL(KIND=JPRB), INTENT(IN) :: RV 
! REAL(KIND=JPRB), INTENT(IN) :: R2ES
! REAL(KIND=JPRB), INTENT(IN) :: R3LES
! REAL(KIND=JPRB), INTENT(IN) :: R3IES
! REAL(KIND=JPRB), INTENT(IN) :: R4LES
! REAL(KIND=JPRB), INTENT(IN) :: R4IES
! REAL(KIND=JPRB), INTENT(IN) :: R5LES
! REAL(KIND=JPRB), INTENT(IN) :: R5IES
! REAL(KIND=JPRB), INTENT(IN) :: R5ALVCP
! REAL(KIND=JPRB), INTENT(IN) :: R5ALSCP
! REAL(KIND=JPRB), INTENT(IN) :: RALVDCP
! REAL(KIND=JPRB), INTENT(IN) :: RALSDCP
! REAL(KIND=JPRB), INTENT(IN) :: RALFDCP
! REAL(KIND=JPRB), INTENT(IN) :: RTWAT
! REAL(KIND=JPRB), INTENT(IN) :: RTICE
! REAL(KIND=JPRB), INTENT(IN) :: RTICECU
! REAL(KIND=JPRB), INTENT(IN) :: RTWAT_RTICE_R
! REAL(KIND=JPRB), INTENT(IN) :: RTWAT_RTICECU_R
! REAL(KIND=JPRB), INTENT(IN) :: RKOOP1
! REAL(KIND=JPRB), INTENT(IN) :: RKOOP2
!-------------------------------------------------------------------------------
...
DO JK=1,KLEV
  DO JL=KIDIA,KFDIA
    ...
    ! with
    CALL CLOUDSC_INIT_SEQ(TENDENCY_LOC_T(JL,JK), TENDENCY_LOC_Q(JL,JK), TENDENCY_LOC_A(JL,JK))
  ENDDO
ENDDO

! and double initialized to be sure :D
CALL CLOUDSC_INIT_VEC(TENDENCY_LOC_T, TENDENCY_LOC_Q, TENDENCY_LOC_A, KLON, KLEV, KIDIA, KFDIA)
