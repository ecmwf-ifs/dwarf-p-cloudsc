...
__global__ void __launch_bounds__(128, 1) cloudsc_c(int kidia, int kfdia, int klon, int klev, float ptsphy,
  ...
  for (jk = 0; jk <= klev + -1; jk += 1) {
    ...
    zfoealfa[jl + klon*(jk + (klev + 1)*ibl)] = 
      ((float)(fminf(1.0, powf((fmaxf(rtice, fminf(rtwat, ztp1[jl + klon*(jk + klev*ibl)])) - rtice)*rtwat_rtice_r, 2))));
    zfoeewmt[jl + klon*(jk + klev*ibl)] = 
        fminf(((float)(r2es*((float)(fminf(1.0, powf((fmaxf(rtice, fminf(rtwat, ztp1[jl + klon*(jk + klev*ibl)])) - rtice)*rtwat_rtice_r, 2)))*
	expf((r3les*(ztp1[jl + klon*(jk + klev*ibl)] - rtt))/(ztp1[jl + klon*(jk + klev*ibl)] - r4les)) + 
	(1.0 - (float)(fminf(1.0, powf((fmaxf(rtice, fminf(rtwat, ztp1[jl + klon*(jk + klev*ibl)])) - rtice)*rtwat_rtice_r, 2))))*
	expf((r3ies*(ztp1[jl + klon*(jk + klev*ibl)] - rtt))/(ztp1[jl + klon*(jk + klev*ibl)] - r4ies))))) / 
    ...
    //---------------------------------------------
    zalfa = ((float)(fmaxf(0.0, copysign(1.0, ztp1[jl + klon*(jk + klev*ibl)] - rtt))));
    zfoeew[jl + klon*(jk + klev*ibl)] = fminf((zalfa*((float)(r2es*expf((r3les*(ztp1[jl + klon*(jk + klev*ibl)] - rtt))/
      (ztp1[jl + klon*(jk + klev*ibl)] - r4les)))) + ((float) 1.0 - zalfa)*
      ((float)(r2es*expf((r3ies*(ztp1[jl + klon*(jk + klev*ibl)] - rtt))/(ztp1[jl + klon*(jk + klev*ibl)] - r4ies)))))/
      pap[jl + klon*(jk + klev*ibl)], (float) 0.5);
    zfoeew[jl + klon*(jk + klev*ibl)] = fminf((float) 0.5, zfoeew[jl + klon*(jk + klev*ibl)]);
    ...
    //----------------------------------
    zfoeeliqt[jl + klon*(jk + klev*ibl)] = fminf(((float)(r2es*expf((r3les*(ztp1[jl + klon*(jk + klev*ibl)] - rtt))/
  ...
  for (jk = 0; jk <= klev + -1; jk += 1) {
    ...
    //------------------------------------------
    za[jl + klon*(jk + klev*ibl)] = 
      fmaxf((float) 0.0, fminf((float) 1.0, za[jl + klon*(jk + klev*ibl)]));
  ...
  for (jk = -1 + (*yrecldp).ncldtop; jk <= klev + -1; jk += 1) {
    ...
    // liquid
    zfacw = r5les / (powf((ztp1[jl + klon*(jk + klev*ibl)] - r4les), 2));
    ...
    // ice
    zfaci = r5ies / (powf((ztp1[jl + klon*(jk + klev*ibl)] - r4ies), 2));
    ...
    zcorqsmix = (float) 1.0 + ((float)((float)(fminf(1.0, powf((fmaxf(rtice, fminf(rtwat, ztp1[jl + klon*(jk + klev*ibl)])) - rtice)*
      rtwat_rtice_r, 2)))*ralvdcp + (1.0 - (float)(fminf(1.0, powf((fmaxf(rtice, fminf(rtwat, ztp1[jl + klon*(jk + klev*ibl)])) - rtice)*
      rtwat_rtice_r, 2))))*ralsdcp))*zdqsmixdt;
    
    // evaporation/sublimation limits
    zevaplimmix = fmaxf((zqsmix[jl + klon*(jk + klev*ibl)] - 
      zqx[jl + klon*(jk + klev*(4 + 5*ibl))]) / zcorqsmix, (float) 0.0);
    zevaplimliq = fmaxf((zqsliq[jl + klon*(jk + klev*ibl)] - 
      zqx[jl + klon*(jk + klev*(4 + 5*ibl))]) / zcorqsliq, (float) 0.0);
    zevaplimice = fmaxf((zqsice[jl + klon*(jk + klev*ibl)] - 
      zqx[jl + klon*(jk + klev*(4 + 5*ibl))]) / zcorqsice, (float) 0.0);
    
    //--------------------------------
    // in-cloud consensate amount
    //--------------------------------
    ztmpa = (float) 1.0 / fmaxf(za[jl + klon*(jk + klev*ibl)], zepsec);
    ...
    zfokoop = ((float)(fminf(rkoop1 - rkoop2*ztp1[jl + klon*(jk + klev*ibl)], (float)(r2es*expf((r3les*(ztp1[jl + klon*(jk + klev*ibl)] - rtt))/
      (ztp1[jl + klon*(jk + klev*ibl)] - r4les)))*1.0/(float)(r2es*expf((r3ies*(ztp1[jl + klon*(jk + klev*ibl)] - rtt))/
    ...
    if (za[jl + klon*(jk + klev*ibl)] > (float) 1.0 - (*yrecldp).ramin) {
      zsupsat = fmaxf((zqx[jl + klon*(jk + klev*(4 + 5*ibl))] - zfac*zqsice[jl + klon*(jk + klev*ibl)]) / 
        zcorqsice, (float) 0.0);
    } else {
      ...
      zqp1env = (zqx[jl + klon*(jk + klev*(4 + 5*ibl))] - 
        ...
        fmaxf((float) 1.0 - za[jl + klon*(jk + klev*ibl)], zepsilon);
      //& SIGN(MAX(ABS(1.0_JPRB-ZA(JL,JK)),ZEPSILON),1.0_JPRB-ZA(JL,JK))
      zsupsat = fmaxf(((float) 1.0 - za[jl + klon*(jk + klev*ibl)])*(zqp1env - zfac*zqsice[jl + klon*(jk + klev*ibl)]) / 
        zcorqsice, (float) 0.0);
    }
    ...
    if (jk + 1 > (*yrecldp).ncldtop) {
      ...
      zmf = fmaxf((float) 0.0, (pmfu[jl + klon*(jk + klev*ibl)] + pmfd[jl + klon*(jk + klev*ibl)])*zdtgdp);
      zacust = zmf*zanewm1;
    ...
    if (jk + 1 < klev) {
      ...
      zmfdn = fmaxf((float) 0.0, (pmfu[jl + klon*(1 + jk + klev*ibl)] + 
    ...
    zdtdiab = fminf(zdpmxdt*zdtdp, fmaxf(-zdpmxdt*zdtdp, zzzdt))*ptsphy + ralfdcp*zldefr;
    ...
    ztp1[jl + klon*(jk + klev*ibl)] = fmaxf(ztp1[jl + klon*(jk + klev*ibl)], (float) 160.0);
    llflag = true;
    
    // Formerly a call to CUADJTQ(..., ICALL=5)
    zqp = (float) 1.0 / pap[jl + klon*(jk + klev*ibl)];
    zqsat = ((float)(r2es*((float)(fminf(1.0, powf((fmaxf(rtice, fminf(rtwat, ztp1[jl + klon*(jk + klev*ibl)])) - rtice)*rtwat_rtice_r, 2)))*
      expf((r3les*(ztp1[jl + klon*(jk + klev*ibl)] - rtt))/(ztp1[jl + klon*(jk + klev*ibl)] - r4les)) + 
      (1.0 - (float)(fminf(1.0, powf((fmaxf(rtice, fminf(rtwat, ztp1[jl + klon*(jk + klev*ibl)])) - rtice)*rtwat_rtice_r, 2))))*
      expf((r3ies*(ztp1[jl + klon*(jk + klev*ibl)] - rtt))/(ztp1[jl + klon*(jk + klev*ibl)] - r4ies)))))*zqp;
    zqsat = fminf((float) 0.5, zqsat);
    zcor = (float) 1.0 / ((float) 1.0 - retv*zqsat);
    zqsat = zqsat*zcor;
    zcond = (zqsmix[jl + klon*(jk + klev*ibl)] - zqsat) / 
      ((float) 1.0 + zqsat*zcor*((float)(((float)(fminf(1.0, powf((fmaxf(rtice, fminf(rtwat, ztp1[jl + klon*(jk + klev*ibl)])) - 
      rtice)*rtwat_rtice_r, 2)))*r5alvcp)*(1.0/powf(ztp1[jl + klon*(jk + klev*ibl)] - r4les, 2)) + 
      ((1.0 - (float)(fminf(1.0, powf((fmaxf(rtice, fminf(rtwat, ztp1[jl + klon*(jk + klev*ibl)])) - rtice)*rtwat_rtice_r, 2))))*r5alscp)*
      (1.0/powf(ztp1[jl + klon*(jk + klev*ibl)] - r4ies, 2)))));
    ztp1[jl + klon*(jk + klev*ibl)] = ztp1[jl + klon*(jk + klev*ibl)] + 
      ((float)((float)(fminf(1.0, powf((fmaxf(rtice, fminf(rtwat, ztp1[jl + klon*(jk + klev*ibl)])) - rtice)*rtwat_rtice_r, 2)))*ralvdcp + 
      (1.0 - (float)(fminf(1.0, powf((fmaxf(rtice, fminf(rtwat, ztp1[jl + klon*(jk + klev*ibl)])) - rtice)*rtwat_rtice_r, 2))))*ralsdcp))*zcond;
    ...
    ztp1[jl + klon*(jk + klev*ibl)] = ztp1[jl + klon*(jk + klev*ibl)] + 
      ((float)((float)(fminf(1.0, powf((fmaxf(rtice, fminf(rtwat, ztp1[jl + klon*(jk + klev*ibl)])) - rtice)*rtwat_rtice_r, 2)))*ralvdcp + 
      (1.0 - (float)(fminf(1.0, powf((fmaxf(rtice, fminf(rtwat, ztp1[jl + klon*(jk + klev*ibl)])) - rtice)*rtwat_rtice_r, 2))))*ralsdcp))*zcond1;
    ...
    if (zdqs > (float) 0.0) {
      ...
      zlevap = za[jl + klon*(jk + klev*ibl)]*fminf(zdqs, zlicld);
      zlevap = fminf(zlevap, zevaplimmix);
      zlevap = fminf(zlevap, fmaxf(zqsmix[jl + klon*(jk + klev*ibl)] - 
        zqx[jl + klon*(jk + klev*(4 + 5*ibl))], (float) 0.0));
    ...
    if (za[jl + klon*(jk + klev*ibl)] > zepsec && zdqs <= -(*yrecldp).rlmin) {
      ...
      if (za[jl + klon*(jk + klev*ibl)] > (float) 0.99) {
        ...
        zcdmax = (zqx[jl + klon*(jk + klev*(4 + 5*ibl))] - zqsmix[jl + klon*(jk + klev*ibl)]) / 
          ...
          (fminf(1.0, powf((fmaxf(rtice, fminf(rtwat, ztp1[jl + klon*(jk + klev*ibl)])) - rtice)*rtwat_rtice_r, 2)))*r5alvcp)*
          (1.0/powf(ztp1[jl + klon*(jk + klev*ibl)] - r4les, 2)) + 
          ((1.0 - (float)(fminf(1.0, powf((fmaxf(rtice, fminf(rtwat, ztp1[jl + klon*(jk + klev*ibl)])) - rtice)*rtwat_rtice_r, 2))))
          *r5alscp)*(1.0/powf(ztp1[jl + klon*(jk + klev*ibl)] - r4ies, 2)))));
      } else {
    ...
    if (zdqs <= -(*yrecldp).rlmin && za[jl + klon*(jk + klev*ibl)] < (float) 1.0 - zepsec) {
      ...
      if (zsigk > (float) 0.8) {
        zrhc = (*yrecldp).ramid + ((float) 1.0 - (*yrecldp).ramid)*(powf(((zsigk - (float) 0.8) / 
          (float) 0.2), 2));
      }
      ...
      if ((*yrecldp).nssopt == 0) {
        ...
        zqe = (zqx[jl + klon*(jk + klev*(4 + 5*ibl))] - za[jl + klon*(jk + klev*ibl)]*
          zqsice[jl + klon*(jk + klev*ibl)]) / fmaxf(zepsec, (float) 1.0 - za[jl + klon*(jk + klev*ibl)]);
        zqe = fmaxf((float) 0.0, zqe);
      } else if ((*yrecldp).nssopt == 1) {
        // Tompkins
        zqe = (zqx[jl + klon*(jk + klev*(4 + 5*ibl))] - za[jl + klon*(jk + klev*ibl)]*
          zqsice[jl + klon*(jk + klev*ibl)]) / fmaxf(zepsec, (float) 1.0 - 
        za[jl + klon*(jk + klev*ibl)]);
        zqe = fmaxf((float) 0.0, zqe);
      ...
      if (zqe >= zrhc*zqsice[jl + klon*(jk + klev*ibl)]*zfac && 
        ...
        zacond = -((float) 1.0 - za[jl + klon*(jk + klev*ibl)])*zfac*zdqs / 
          fmaxf((float) 2.0*(zfac*zqsice[jl + klon*(jk + klev*ibl)] - zqe), zepsec);
        
        zacond = fminf(zacond, (float) 1.0 - za[jl + klon*(jk + klev*ibl)]); //PUT THE LIMITER BACK
        ...
        zzdl = (float) 2.0*(zfac*zqsice[jl + klon*(jk + klev*ibl)] - zqe) / 
          fmaxf(zepsec, (float) 1.0 - za[jl + klon*(jk + klev*ibl)]);
        // Added correction term ZFAC 15/03/2010
        if (zfac*zdqs < -zzdl) {
    ...
    if (idepice == 1) {
      ...
      if (ztp1[jl + klon*(jk + klev*ibl)] < rtt && zqxfg[0] > (*yrecldp).rlmin) {
        ...
        zvpice = ((float)(r2es*expf((r3ies*(ztp1[jl + klon*(jk + klev*ibl)] - rtt))/
          (ztp1[jl + klon*(jk + klev*ibl)] - r4ies))))*rv / rd;
        zvpliq = zvpice*zfokoop;
        zicenuclei = (float) 1000.0*expf((float) 12.96*(zvpliq - zvpice) / zvpliq - (float) 0.639);
        ...
        // new value of ice:
        //------------------
        zinew = powf(((float) 0.666*zcvds*ptsphy + (powf(zice0, (float) 0.666))), (float) 1.5);
        
        //---------------------------
        // grid-mean deposition rate:
        //---------------------------
        zdepos = fmaxf(za[jl + klon*(jk + klev*ibl)]*(zinew - zice0), (float) 0.0);
        ...
        zdepos = zdepos*fminf(zinfactor + ((float) 1.0 - zinfactor)*((*yrecldp).rdepliqrefrate + 
      ...
      if (ztp1[jl + klon*(jk + klev*ibl)] < rtt && zqxfg[0] > (*yrecldp).rlmin) {
        ...
        zaplusb = (*yrecldp).rcl_apb1*zvpice - (*yrecldp).rcl_apb2*zvpice*
          ...
          (*yrecldp).rcl_apb3*(powf(ztp1[jl + klon*(jk + klev*ibl)], (float) 3.));
        zcorrfac = powf(((float) 1.0 / zrho), (float) 0.5);
        zcorrfac2 = (powf((ztp1[jl + klon*(jk + klev*ibl)] / (float) 273.0), (float)1.5))*
          ((float) 393.0 / (ztp1[jl + klon*(jk + klev*ibl)] + (float) 120.0));
        
        zpr02 = zrho*zice0*(*yrecldp).rcl_const1i / (ztcg*zfacx1i);
        
        zterm1 = (zvpliq - zvpice)*(powf(ztp1[jl + klon*(jk + klev*ibl)], (float) 2.0))*
          zvpice*zcorrfac2*ztcg*(*yrecldp).rcl_const2i*zfacx1i / (zrho*zaplusb*zvpice);
        zterm2 = (float) 0.65*(*yrecldp).rcl_const6i*(powf(zpr02, (*yrecldp).rcl_const4i)) + 
          (*yrecldp).rcl_const3i*(powf(zcorrfac, (float) 0.5))*(powf(zrho, (float) 0.5))*
          (powf(zpr02, (*yrecldp).rcl_const5i)) / (powf(zcorrfac2, (float) 0.5));
        
        zdepos = fmaxf(za[jl + klon*(jk + klev*ibl)]*zterm1*zterm2*ptsphy, (float) 0.0);
        ...
        // to increase deposition rate with decreasing temperatures
        zinfactor = fminf(zicenuclei / (float) 15000., (float) 1.0);
        zdepos = zdepos*fminf(zinfactor + ((float) 1.0 - zinfactor)*
    ...
    if (zqpretot > zepsec) {
      zcovptot = (float) 1.0 - (((float) 1.0 - zcovptot)*((float) 1.0 - 
        fmaxf(za[jl + klon*(jk + klev*ibl)], za[jl + klon*(-1 + jk + klev*ibl)])) / 
	((float) 1.0 - fminf(za[jl + klon*(-1 + jk + klev*ibl)], (float) 1.0 - (float) 1.E-06)));
      zcovptot = fmaxf(zcovptot, (*yrecldp).rcovpmin);
      zcovpclr = fmaxf((float) 0.0, zcovptot - za[jl + klon*(jk + klev*ibl)]);          // clear sky proportion
    ...
    if (ztp1[jl + klon*(jk + klev*ibl)] <= rtt) {
      ...
      if (zicecld > zepsec) {
        ...
        zzco = ptsphy*(*yrecldp).rsnowlin1*expf((*yrecldp).rsnowlin2*
          (ztp1[jl + klon*(jk + klev*ibl)] - rtt));
        
        if ((*yrecldp).laericeauto) {
          zlcrit = picrit_aer[jl + klon*(jk + klev*ibl)];
          // 0.3 = N**0.333 with N=0.027
          zzco = zzco*(powf(((*yrecldp).rnice / pnice[jl + klon*(jk + klev*ibl)]), (float) 0.333));
        } else {
    ...
    if (zliqcld > zepsec) {
      ...
      if (iwarmrain == 1) {
        ...
        if ((*yrecldp).laerliqautolsp) {
          ...
          zzco = zzco*(powf(((*yrecldp).rccn / pccn[jl + klon*(jk + klev*ibl)]), (float) 0.333));
        } else {
        ...
        zprecip = (zpfplsx[jl + klon*(jk + (klev + 1)*(3 + 5*ibl))] + 
          zpfplsx[jl + klon*(jk + (klev + 1)*(2 + 5*ibl))]) / fmaxf(zepsec, zcovptot);
        ...
        if ((*yrecldp).laerliqcoll) {
          ...
          zcfpr = zcfpr*(powf(((*yrecldp).rccn / pccn[jl + klon*(jk + klev*ibl)]), (float) 0.333));
        }
        ...
        if (zliqcld > zlcrit) {
          ...
          zrainaut = (float) 1.5*za[jl + klon*(jk + klev*ibl)]*ptsphy*
            (*yrecldp).rcl_kkaau*(powf(zliqcld, (*yrecldp).rcl_kkbauq))*
            (powf(zconst, (*yrecldp).rcl_kkbaun));
          ...
          zrainacc = (float) 2.0*za[jl + klon*(jk + klev*ibl)]*ptsphy*(*yrecldp).rcl_kkaac*
            (powf((zliqcld*zraincld), (*yrecldp).rcl_kkbac));
      ...
      if (ztp1[jl + klon*(jk + klev*ibl)] <= rtt && zliqcld > zepsec) {
        ...
        if (zsnowcld > zepsec && zcovptot > (float) 0.01) {
          ...
          zsnowrime = (float) 0.3*zcovptot*ptsphy*(*yrecldp).rcl_const7s*
            zfallcorr*(powf((zrho*zsnowcld*(*yrecldp).rcl_const1s), (*yrecldp).rcl_const8s));
    ...
    if (zicetot > zepsec && ztp1[jl + klon*(jk + klev*ibl)] > rtt) {
      ...
      zsubsat = fmaxf(zqsice[jl + klon*(jk + klev*ibl)] - 
        zqx[jl + klon*(jk + klev*(4 + 5*ibl))], (float) 0.0);
      ...
      zcons1 = fabsf(ptsphy*((float) 1.0 + (float) 0.5*ztdmtw0) / (*yrecldp).rtaumel);
    ...
    if (zqx[jl + klon*(jk + klev*(2 + 5*ibl))] > zepsec) {
      ...
      if (ztp1[jl + klon*(jk + klev*ibl)] <= rtt && ztp1[jl + klon*(-1 + jk + klev*ibl)] > rtt) {
        ...
        zqpretot = fmaxf(zqx[jl + klon*(jk + klev*(3 + 5*ibl))] + 
      ...
      if (ztp1[jl + klon*(jk + klev*ibl)] < rtt) {
        ...
        if (prainfrac_toprfz[jl + klon*ibl] > 0.8) {
          ...
          zlambda = powf(((*yrecldp).rcl_fac1 / (zrho*zqx[jl + klon*(jk + klev*(2 +5*ibl))])), 
            (*yrecldp).rcl_fac2);
          
          // Calculate freezing rate based on Bigg(1953) and Wisner(1972)
          ztemp = (*yrecldp).rcl_fzrab*(ztp1[jl + klon*(jk + klev*ibl)] - rtt);
          zfrz = ptsphy*((*yrecldp).rcl_const5r / zrho)*(expf(ztemp) -
            (float) 1.)*(powf(zlambda, (*yrecldp).rcl_const6r));
          ...
          zcons1 = fabsf(ptsphy*((float) 1.0 + (float) 0.5*(rtt - 
            ztp1[jl + klon*(jk + klev*ibl)])) / (*yrecldp).rtaumel);
          zfrzmax = fmaxf((rtt - ztp1[jl + klon*(jk + klev*ibl)])*zcons1*zrldcp, (float) 0.0);
          
        }
        
        if (zfrzmax > zepsec) {
          zfrz = fminf(zqx[jl + klon*(jk + klev*(2 + 5*ibl))], zfrzmax);
    ...
    //----------------------------------------------------------------------
    // not implicit yet...
    zfrzmax = fmaxf(((*yrecldp).rthomo - ztp1[jl + klon*(jk + klev*ibl)])*zrldcp, (float) 0.0);
    ...
    if (ievaprain == 1) {
      ...
      zqe = (zqx[jl + klon*(jk + klev*(4 + 5*ibl))] - za[jl + klon*(jk + klev*ibl)]*
        zqsliq[jl + klon*(jk + klev*ibl)]) / fmaxf(zepsec, (float) 1.0 - za[jl + klon*(jk + klev*ibl)]);
      //---------------------------------------------
      // humidity in moistest ZCOVPCLR part of domain
      //---------------------------------------------
      zqe = fmaxf((float) 0.0, fminf(zqe, zqsliq[jl + klon*(jk + klev*ibl)]));
      llo1 = zcovpclr > zepsec && zqxfg[2] > zepsec && zqe < zzrh*zqsliq[jl + klon*(jk + klev*ibl)];
      
      if (llo1) {
        // note: zpreclr is a rain flux
        zpreclr = zqxfg[2]*zcovpclr / copysign(fmaxf(fabsf(zcovptot*zdtgdp), zepsilon), zcovptot*zdtgdp);
        ...
        zbeta1 = sqrt(pap[jl + klon*(jk + klev*ibl)] / paph[jl + klon*(klev + (klev + 1)*ibl)]) / 
          (*yrecldp).rvrfactor*zpreclr / fmaxf(zcovpclr, zepsec);
      ...
      zqe = fmaxf((float) 0.0, fminf(zqx[jl + klon*(jk + klev*(4 + 5*ibl))], 
      ...
      if (llo1) {
        ...
        zesatliq = rv / rd*((float)(r2es*expf((r3les*(ztp1[jl + klon*(jk + klev*ibl)] - rtt))/
        ...
        zevap_denom = (*yrecldp).rcl_cdenom1*zesatliq - (*yrecldp).rcl_cdenom2*
          ...
          (powf(ztp1[jl + klon*(jk + klev*ibl)], (float) 3.))*pap[jl + klon*(jk + klev*ibl)];
        
        // Temperature dependent conductivity
        zcorr2 = (powf((ztp1[jl + klon*(jk + klev*ibl)] / (float) 273.), (float) 1.5))*(float) 393. / 
          (ztp1[jl + klon*(jk + klev*ibl)] + (float) 120.);
        zka = (*yrecldp).rcl_ka273*zcorr2;
        
        zsubsat = fmaxf(zzrh*zqsliq[jl + klon*(jk + klev*ibl)] - zqe, (float) 0.0);
        
        zbeta = ((float) 0.5 / zqsliq[jl + klon*(jk + klev*ibl)])*
          (powf(ztp1[jl + klon*(jk + klev*ibl)], (float) 2.))*zesatliq*(*yrecldp).rcl_const1r*(zcorr2 / 
          zevap_denom)*((float) 0.78 / (powf(zlambda, (*yrecldp).rcl_const4r)) + 
          (*yrecldp).rcl_const2r*(powf((zrho*zfallcorr), (float) 0.5)) / ((powf(zcorr2, 
        ...
        // 2-flux treatment, abandoned due to the new prognostic precip
        //-------------------------------------------------------------
        zcovptot = fmaxf((*yrecldp).rcovpmin, zcovptot - fmaxf((float) 0.0, (zcovptot - 
    ...
    if (ievapsnow == 1) {
      ...
      // humidity in moistest ZCOVPCLR part of domain
      //---------------------------------------------
      zqe = fmaxf((float) 0.0, fminf(zqe, zqsice[jl + klon*(jk + klev*ibl)]));
      llo1 = zcovpclr > zepsec && zqxfg[3] > zepsec && 
        zqe < zzrh*zqsice[jl + klon*(jk + klev*ibl)];
      
      if (llo1) {
        // note: zpreclr is a rain flux a
        zpreclr = zqxfg[3]*zcovpclr / copysign(fmaxf(fabsf(zcovptot*zdtgdp), zepsilon), zcovptot*zdtgdp);
      ...
      if (llo1) {
        ...
        zvpice = ((float)(r2es*expf((r3ies*(ztp1[jl + klon*(jk + klev*ibl)] - rtt))/(ztp1[jl + klon*(jk + klev*ibl)] - r4ies))))*rv / rd;
        ...
        zaplusb = (*yrecldp).rcl_apb1*zvpice - (*yrecldp).rcl_apb2*zvpice*
          ...
          (powf(ztp1[jl + klon*(jk + klev*ibl)], 3));
        zcorrfac = powf((1.0 / zrho), 0.5);
        zcorrfac2 = (powf((ztp1[jl + klon*(jk + klev*ibl)] / 273.0), 1.5))*(393.0 / (ztp1[jl + klon*(jk + klev*ibl)] + 120.0));
        
        zpr02 = zrho*zpreclr*(*yrecldp).rcl_const1s / (ztcg*zfacx1s);
        
        zterm1 = (zqsice[jl + klon*(jk + klev*ibl)] - zqe)*(powf(ztp1[jl + klon*(jk + klev*ibl)], 2))*
        ...
        zevap = fminf(zevap, zqx[jl + klon*(jk + klev*(3 + 5*ibl))]);
    ...
    //---------------------------------------
    for (jm = 0; jm <= 5 + -1; jm += 1) {
      zmax = fmaxf(zqx[jl + klon*(jk + klev*(jm + 5*ibl))], zepsec);
    ...
    for (jm = 0; jm <= 5 + -1; jm += 1) {
      ...
      //---------------------------
      zmm = fmaxf(zqx[jl + klon*(jk + klev*(jm + 5*ibl))], zepsec);
