module cloudsc_c_k_caching_cuda_mod 
  ...
  public :: cloudsc_c_cuda

  interface 

    subroutine cloudsc_c_cuda_launch(numcols, nproma, kidia, kfdia, klon, ptsphy, pt, &
          ...
          & rtwat_rtice_r, rtwat_rticecu_r, rkoop1, rkoop2) bind(c, name='cloudsc_c_cuda_launch')
   ...
   end subroutine cloudsc_c_cuda_launch
  
  end interface

  contains

    subroutine cloudsc_c_cuda(numcols, nproma, kidia, kfdia, klon, klev, ptsphy, pt, &
          & pq, tendency_tmp_t, tendency_tmp_q, tendency_tmp_a, tendency_tmp_cld, tendency_loc_t, &
          & tendency_loc_q, tendency_loc_a, tendency_loc_cld, pvfa, pvfl, pvfi, pdyna, &
          & pdynl, pdyni, phrsw, phrlw, pvervel, pap, paph, plsm, ktype, plu, plude, psnde, &
          & pmfu, pmfd, pa, pclv, psupsat, plcrit_aer, picrit_aer, pre_ice, pccn, pnice, &
        ...
        !   & pfcqrng, pfcqsng, pfsqltur, pfsqitur, pfplsl, pfplsn, pfhpsl, pfhpsn
        ! integer(c_int), value :: numcols, nproma, kidia, kfdia, klon, ngpblks
        ! real(c_double), value :: rg, rd, rcpd, retv, rlvtt, rlstt, rlmlt, rtt, rv, r2es, &
        !   & r3les, r3ies, r4les, r4ies, r5les, r5ies, r5alvcp, r5alscp, ralvdcp, ralsdcp, &
        !   & ralfdcp, rtwat, rtice, rticecu, rtwat_rtice_r, rtwat_rticecu_r, rkoop1, rkoop2

        ! tendency_tmp_t
        ! tendency_tmp_q, tendency_tmp_a,
        ! tendency_tmp_cld, tendency_loc_t,
        ...
        CALL cloudsc_c_cuda_launch(numcols, nproma, kidia, kfdia, klon, ptsphy, & 
    ...
    end subroutine cloudsc_c_cuda 

end module cloudsc_c_k_caching_cuda_mod
