...
CONTAINS
  ...
  SUBROUTINE CLOUDSC_GLOBAL_STATE_VALIDATE(THIS, NPROMA, NGPTOT)
    ...
    CALL LOAD_AND_EXPAND('PLUDE', PLUDE, KLON, THIS%KLEV, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND('PCOVPTOT', PCOVPTOT, KLON, THIS%KLEV, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND('PRAINFRAC_TOPRFZ', PRAINFRAC_TOPRFZ, KLON, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND('PFSQLF', PFSQLF, KLON, THIS%KLEV+1, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND('PFSQIF', PFSQIF, KLON, THIS%KLEV+1, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND('PFCQLNG', PFCQLNG, KLON, THIS%KLEV+1, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND('PFCQNNG', PFCQNNG, KLON, THIS%KLEV+1, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND('PFSQRF', PFSQRF, KLON, THIS%KLEV+1, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND('PFSQSF', PFSQSF, KLON, THIS%KLEV+1, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND('PFCQRNG', PFCQRNG, KLON, THIS%KLEV+1, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND('PFCQSNG', PFCQSNG, KLON, THIS%KLEV+1, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND('PFSQLTUR', PFSQLTUR, KLON, THIS%KLEV+1, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND('PFSQITUR', PFSQITUR, KLON, THIS%KLEV+1, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND('PFPLSL', PFPLSL, KLON, THIS%KLEV+1, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND('PFPLSN', PFPLSN, KLON, THIS%KLEV+1, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND('PFHPSL', PFHPSL, KLON, THIS%KLEV+1, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND('PFHPSN', PFHPSN, KLON, THIS%KLEV+1, NPROMA, NGPTOT, NBLOCKS)
    CALL LOAD_AND_EXPAND_STATE('TENDENCY_LOC', TENDENCY_LOC, B_LOC, KLON, THIS%KLEV, NCLV, &
         & NPROMA, NGPTOT, NBLOCKS)
    CALL FINALIZE()

    ! Actual variable validation
    CALL VALIDATE('PLUDE', PLUDE, THIS%PLUDE, NPROMA, THIS%KLEV, NGPTOT, NBLOCKS)
    CALL VALIDATE('PCOVPTOT', PCOVPTOT, THIS%PCOVPTOT, NPROMA, THIS%KLEV, NGPTOT, NBLOCKS)
    CALL VALIDATE('PRAINFRAC_TOPRFZ', PRAINFRAC_TOPRFZ, THIS%PRAINFRAC_TOPRFZ, NPROMA, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFSQLF', PFSQLF, THIS%PFSQLF, NPROMA, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFSQIF', PFSQIF, THIS%PFSQIF, NPROMA, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFCQLNG', PFCQLNG, THIS%PFCQLNG, NPROMA, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFCQNNG', PFCQNNG, THIS%PFCQNNG, NPROMA, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFSQRF', PFSQRF, THIS%PFSQRF, NPROMA, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFSQSF', PFSQSF, THIS%PFSQSF, NPROMA, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFCQRNG', PFCQRNG, THIS%PFCQRNG, NPROMA, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFCQSNG', PFCQSNG, THIS%PFCQSNG, NPROMA, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFSQLTUR', PFSQLTUR, THIS%PFSQLTUR, NPROMA, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFSQITUR', PFSQITUR, THIS%PFSQITUR, NPROMA, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFPLSL', PFPLSL, THIS%PFPLSL, NPROMA, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFPLSN', PFPLSN, THIS%PFPLSN, NPROMA, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFHPSL', PFHPSL, THIS%PFHPSL, NPROMA, THIS%KLEV+1, NGPTOT, NBLOCKS)
    CALL VALIDATE('PFHPSN', PFHPSN, THIS%PFHPSN, NPROMA, THIS%KLEV+1, NGPTOT, NBLOCKS)
    ! This is extremly hacky, but the array-of-struct-of-array layout demands it.
    CALL VALIDATE('TENDENCY_LOC%A', B_LOC(:,:,5,:), THIS%B_LOC(:,:,5,:), NPROMA, THIS%KLEV, NGPTOT, NBLOCKS)
    CALL VALIDATE('TENDENCY_LOC%Q', B_LOC(:,:,6,:), THIS%B_LOC(:,:,6,:), NPROMA, THIS%KLEV, NGPTOT, NBLOCKS)
    CALL VALIDATE('TENDENCY_LOC%T', B_LOC(:,:,3,:), THIS%B_LOC(:,:,3,:), NPROMA, THIS%KLEV, NGPTOT, NBLOCKS)
    CALL VALIDATE('TENDENCY_LOC%CLD', B_LOC(:,:,7:,:), THIS%B_LOC(:,:,7:,:), NPROMA, THIS%KLEV, NCLV, NGPTOT, NBLOCKS)
