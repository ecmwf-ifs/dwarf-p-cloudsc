...
!USE YOMPHYDER ,ONLY : STATE_TYPE
ASSOCIATE(        RKCONV=>YDECLDP%RKCONV                 , &
                   RLMIN=>YDECLDP%RLMIN                  , &
                 ...
                 RALFDCP=>YDOETHF%RALFDCP                , &
                   RTWAT=>YDOETHF%RTWAT                  , &
                   RTICE=>YDOETHF%RTICE                  , &
                 RTICECU=>YDOETHF%RTICECU                , &
           RTWAT_RTICE_R=>YDOETHF%RTWAT_RTICE_R          , &
         RTWAT_RTICECU_R=>YDOETHF%RTWAT_RTICECU_R        , &
                  RKOOP1=>YDOETHF%RKOOP1                 , &
                  RKOOP2=>YDOETHF%RKOOP2                 , &
             LAERICEAUTO=>YDECLDP%LAERICEAUTO            , &
              LAERICESED=>YDECLDP%LAERICESED             , &
          LAERLIQAUTOLSP=>YDECLDP%LAERLIQAUTOLSP         , &
             LAERLIQCOLL=>YDECLDP%LAERLIQCOLL            , &
              LCLDBUDGET=>YDECLDP%LCLDBUDGET             , &
                 NCLDTOP=>YDECLDP%NCLDTOP                , &
                  NSSOPT=>YDECLDP%NSSOPT                 , &
                   RAMID=>YDECLDP%RAMID                  , &
                   RAMIN=>YDECLDP%RAMIN                  , &
                    RCCN=>YDECLDP%RCCN                   , &
            RCLCRIT_LAND=>YDECLDP%RCLCRIT_LAND           , &
             RCLCRIT_SEA=>YDECLDP%RCLCRIT_SEA            , &
                 RCLDIFF=>YDECLDP%RCLDIFF                , &
           RCLDIFF_CONVI=>YDECLDP%RCLDIFF_CONVI          , &
               RCLDTOPCF=>YDECLDP%RCLDTOPCF              , &
                RCL_APB1=>YDECLDP%RCL_APB1               , &
                RCL_APB2=>YDECLDP%RCL_APB2               , &
                RCL_APB3=>YDECLDP%RCL_APB3               , &
             RCL_CDENOM1=>YDECLDP%RCL_CDENOM1            , &
             RCL_CDENOM2=>YDECLDP%RCL_CDENOM2            , &
             RCL_CDENOM3=>YDECLDP%RCL_CDENOM3            , &
             RCL_CONST1I=>YDECLDP%RCL_CONST1I            , &
             RCL_CONST1R=>YDECLDP%RCL_CONST1R            , &
             RCL_CONST1S=>YDECLDP%RCL_CONST1S            , &
             RCL_CONST2I=>YDECLDP%RCL_CONST2I            , &
             RCL_CONST2R=>YDECLDP%RCL_CONST2R            , &
             RCL_CONST2S=>YDECLDP%RCL_CONST2S            , &
             RCL_CONST3I=>YDECLDP%RCL_CONST3I            , &
             RCL_CONST3R=>YDECLDP%RCL_CONST3R            , &
             RCL_CONST3S=>YDECLDP%RCL_CONST3S            , &
             RCL_CONST4I=>YDECLDP%RCL_CONST4I            , &
             RCL_CONST4R=>YDECLDP%RCL_CONST4R            , &
             RCL_CONST4S=>YDECLDP%RCL_CONST4S            , &
             RCL_CONST5I=>YDECLDP%RCL_CONST5I            , &
             RCL_CONST5R=>YDECLDP%RCL_CONST5R            , &
             RCL_CONST5S=>YDECLDP%RCL_CONST5S            , &
             RCL_CONST6I=>YDECLDP%RCL_CONST6I            , &
             RCL_CONST6R=>YDECLDP%RCL_CONST6R            , &
             RCL_CONST6S=>YDECLDP%RCL_CONST6S            , &
             RCL_CONST7S=>YDECLDP%RCL_CONST7S            , &
             RCL_CONST8S=>YDECLDP%RCL_CONST8S            , &
                RCL_FAC1=>YDECLDP%RCL_FAC1               , &
                RCL_FAC2=>YDECLDP%RCL_FAC2               , &
               RCL_FZRAB=>YDECLDP%RCL_FZRAB              , &
               RCL_KA273=>YDECLDP%RCL_KA273              , &
               RCL_KKAAC=>YDECLDP%RCL_KKAAC              , &
               RCL_KKAAU=>YDECLDP%RCL_KKAAU              , &
               RCL_KKBAC=>YDECLDP%RCL_KKBAC              , &
              RCL_KKBAUN=>YDECLDP%RCL_KKBAUN             , &
