...
CONTAINS
  ...
  SUBROUTINE CLOUDSC_GLOBAL_ATLAS_STATE_LOAD(SELF, FSET, FSPACE, NPROMA, NGPTOTG)
    ...
    IF (LMULTIFIELD) THEN
      MULTIFIELD_IN = atlas_MultiField(ATLAS_REAL(JPRB), [NPROMA, FSPACE%LEVELS(), -1, FSPACE%NBLKS()], IN_VAR_NAMES(1:24))
    ...
    IF (LMULTIFIELD) THEN
      MULTIFIELD_OUT = atlas_MultiField(ATLAS_REAL(JPRB), [NPROMA, FSPACE%LEVELS()+1, -1, FSPACE%NBLKS()], OUT_VAR_NAMES(1:14))
