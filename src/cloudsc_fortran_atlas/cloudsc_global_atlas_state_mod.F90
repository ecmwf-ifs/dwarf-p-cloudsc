...
CONTAINS
  ...
  SUBROUTINE CLOUDSC_GLOBAL_ATLAS_STATE_BLOCK(SELF, FSET, IBLK)
    ...
    CALL FSET%DATA(32, SELF%PFSQLF, IBLK)
    CALL FSET%DATA(33, SELF%PFSQIF, IBLK)
    CALL FSET%DATA(34, SELF%PFCQLNG, IBLK)
    CALL FSET%DATA(35, SELF%PFCQNNG, IBLK)
    CALL FSET%DATA(36, SELF%PFSQRF, IBLK)
    CALL FSET%DATA(37, SELF%PFSQSF, IBLK)
    CALL FSET%DATA(38, SELF%PFCQRNG, IBLK)
    CALL FSET%DATA(39, SELF%PFCQSNG, IBLK)
    CALL FSET%DATA(40, SELF%PFSQLTUR, IBLK)
    CALL FSET%DATA(41, SELF%PFSQITUR, IBLK)
    CALL FSET%DATA(42, SELF%PFPLSL, IBLK)
    CALL FSET%DATA(43, SELF%PFPLSN, IBLK)
    CALL FSET%DATA(44, SELF%PFHPSL, IBLK)
    CALL FSET%DATA(45, SELF%PFHPSN, IBLK)
    CALL FSET%DATA(46, SELF%PCOVPTOT, IBLK)
    CALL FSET%DATA(47, SELF%PRAINFRAC_TOPRFZ, IBLK)
    CALL FSET%DATA(48, TMP3D, IBLK)
  ...
  SUBROUTINE CLOUDSC_GLOBAL_ATLAS_STATE_LOAD(SELF, FSET, FSPACE, NPROMA, NGPTOTG)
    ...
    INTEGER, PARAMETER :: NUM_IN_MFIELDS = 24
