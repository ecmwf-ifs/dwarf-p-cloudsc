...
CONTAINS
  ...
  SUBROUTINE CLOUDSC_GLOBAL_ATLAS_STATE_LOAD(SELF, FSET, NPROMA, NGPTOT, NGPTOTG)
    ...
    INTEGER(KIND=JPIM), INTENT(INOUT) :: NGPTOT
    ...
    PARTITIONER = ATLAS_PARTITIONER("bands")
    FSPACE = ATLAS_FUNCTIONSPACE_BLOCKSTRUCTUREDCOLUMNS(GRID, PARTITIONER, LEVELS=SELF%KLEV, NPROMA=NPROMA, HALO=0)
    NGPTOT = FSPACE%SIZE()
