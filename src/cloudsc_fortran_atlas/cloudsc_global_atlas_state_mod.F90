...
!    call field%update_device()
    ...
    CALL FSET%DATA("PLCRIT_AER", SELF%PLCRIT_AER, IBLK)
    CALL FSET%DATA("PICRIT_AER", SELF%PICRIT_AER, IBLK)
    CALL FSET%DATA("PRE_ICE", SELF%PRE_ICE, IBLK)
    CALL FSET%DATA("PCCN", SELF%PCCN, IBLK)
    CALL FSET%DATA("PNICE", SELF%PNICE, IBLK)
    CALL FSET%DATA("PT", SELF%PT, IBLK)
    CALL FSET%DATA("PQ", SELF%PQ, IBLK)
    CALL FSET%DATA("PVFA", SELF%PVFA, IBLK)
    CALL FSET%DATA("PVFL", SELF%PVFL, IBLK)
    CALL FSET%DATA("PVFI", SELF%PVFI, IBLK)
    CALL FSET%DATA("PDYNA", SELF%PDYNA, IBLK)
    CALL FSET%DATA("PDYNL", SELF%PDYNL, IBLK)
    CALL FSET%DATA("PDYNI", SELF%PDYNI, IBLK)
    CALL FSET%DATA("PHRSW", SELF%PHRSW, IBLK)
    CALL FSET%DATA("PHRLW", SELF%PHRLW, IBLK)
    CALL FSET%DATA("PVERVEL", SELF%PVERVEL, IBLK)
    CALL FSET%DATA("PAP", SELF%PAP, IBLK)
    CALL FSET%DATA("PLU", SELF%PLU, IBLK)
    CALL FSET%DATA("PLUDE", SELF%PLUDE, IBLK)
    CALL FSET%DATA("PSNDE", SELF%PSNDE, IBLK)
    CALL FSET%DATA("PMFU", SELF%PMFU, IBLK)
    CALL FSET%DATA("PMFD", SELF%PMFD, IBLK)
    CALL FSET%DATA("PA", SELF%PA, IBLK)
    CALL FSET%DATA("PSUPSAT", SELF%PSUPSAT, IBLK)
    CALL FSET%DATA("PLSM", SELF%PLSM, IBLK)
    CALL FSET%DATA("LDCUM", SELF%LDCUM, IBLK)
    CALL FSET%DATA("KTYPE", SELF%KTYPE, IBLK)
    CALL FSET%DATA("PAPH", SELF%PAPH, IBLK)
    CALL FSET%DATA("PEXTRA", SELF%PEXTRA, IBLK)
    CALL FSET%DATA("PCLV", SELF%PCLV, IBLK)

    CALL FSET%DATA("TENDENCY_CML", TMP3D, IBLK)
    SELF%TENDENCY_CML%T   => TMP3D(:,:,1)
    SELF%TENDENCY_CML%A   => TMP3D(:,:,2)
    SELF%TENDENCY_CML%Q   => TMP3D(:,:,3)
    SELF%TENDENCY_CML%CLD => TMP3D(:,:,4:)
    CALL FSET%DATA("TENDENCY_TMP", TMP3D, IBLK)
    SELF%TENDENCY_TMP%T   => TMP3D(:,:,1)
    SELF%TENDENCY_TMP%A   => TMP3D(:,:,2)
    SELF%TENDENCY_TMP%Q   => TMP3D(:,:,3)
    SELF%TENDENCY_TMP%CLD => TMP3D(:,:,4:)
    CALL FSET%DATA("TENDENCY_LOC", TMP3D, IBLK)
    SELF%TENDENCY_LOC%T   => TMP3D(:,:,1)
    SELF%TENDENCY_LOC%A   => TMP3D(:,:,2)
    SELF%TENDENCY_LOC%Q   => TMP3D(:,:,3)
    SELF%TENDENCY_LOC%CLD => TMP3D(:,:,4:)

    CALL FSET%DATA("PFSQLF", SELF%PFSQLF, IBLK)
    CALL FSET%DATA("PFSQIF", SELF%PFSQIF, IBLK)
    CALL FSET%DATA("PFCQLNG", SELF%PFCQLNG, IBLK)
    CALL FSET%DATA("PFCQNNG", SELF%PFCQNNG, IBLK)
    CALL FSET%DATA("PFSQRF", SELF%PFSQRF, IBLK)
    CALL FSET%DATA("PFSQSF", SELF%PFSQSF, IBLK)
    CALL FSET%DATA("PFCQRNG", SELF%PFCQRNG, IBLK)
    CALL FSET%DATA("PFCQSNG", SELF%PFCQSNG, IBLK)
    CALL FSET%DATA("PFSQLTUR", SELF%PFSQLTUR, IBLK)
    CALL FSET%DATA("PFSQITUR", SELF%PFSQITUR, IBLK)
    CALL FSET%DATA("PFPLSL", SELF%PFPLSL, IBLK)
    CALL FSET%DATA("PFPLSN", SELF%PFPLSN, IBLK)
    CALL FSET%DATA("PFHPSL", SELF%PFHPSL, IBLK)
    CALL FSET%DATA("PFHPSN", SELF%PFHPSN, IBLK)
    CALL FSET%DATA("PCOVPTOT", SELF%PCOVPTOT, IBLK)
    CALL FSET%DATA("PRAINFRAC_TOPRFZ", SELF%PRAINFRAC_TOPRFZ, IBLK)
