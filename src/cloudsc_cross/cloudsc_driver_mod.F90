...
MODULE CLOUDSC_DRIVER_MOD
  ...
  USE cloudsc_c_k_caching_mod, only: cloudsc_c_wrapper 
  IMPLICIT NONE
  ...
  & PFPLSN, PFHPSL, PFHPSN)
    ...
    !$acc data &
    !$acc copyin( &
    !$acc   pt,pq,tendency_tmp_t, tendency_tmp_q, tendency_tmp_a, tendency_tmp_cld,pvfa, &
    ...
    !$acc copy( &
    !$acc   tendency_loc_t, tendency_loc_q, tendency_loc_a, tendency_loc_cld, plude,pcovptot,prainfrac_toprfz) &
    !$acc copyout( &
 ...
 1003 FORMAT(5X, 'NUMPROC=', I0, ', NUMOMP=', I0, ', NGPTOTG=', I0, ', NPROMA=', I0, ', NGPBLKS=', I0)
    ...
    CALL cloudsc_c_wrapper(ngptot, nproma, 1, nproma, nproma, nlev, ptsphy, pt, &
